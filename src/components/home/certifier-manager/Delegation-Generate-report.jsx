...
import {
  GET_CERTIFIER_DELEGATION_REPORT_STATUS,
  GET_CERTIFIER_DELEGATION_RECORD_STATUS
...
// 路由
import {
  HOME_DELEGATION_CERTIFY_EXAMINE_REPORT,
  HOME_DELEGATION_CERTIFY_EXAMINE_ORIGINAL_RECORD
                  ...
                  <Timeline mode='left' className='timeline-box'>
                    ...
                    >
                      {reportStatus > 2 || reportStatus === -3 ? (
                        <Link
                          to={HOME_DELEGATION_CERTIFY_EXAMINE_REPORT.path}
                  ...
                  <Timeline mode='left' className='timeline-box'>
                    ...
                    >
                      {recordStatus > 2 || recordStatus === -3 ? (
                        <Link
                          to={
                            HOME_DELEGATION_CERTIFY_EXAMINE_ORIGINAL_RECORD.path
                          }
                          className={isCurrentStep ? '' : 'old-link'}
                        >
                          <span>批准人审查原始记录</span>
