...
import {
  ...
  GET_CERTIFIER_DELEGATION_TEST_SPECIMEN
} from '@/constants/api-constants';

// 路由
import { HOME_DELEGATION_CERTIFY_DETAIL_APPLY } from '@/constants/route-constants';
                ...
                <Timeline mode='left' className='timeline-box'>
                  ...
                  >
                    {applyManagerStatus > 2 || applyManagerStatus === -3 ? (
                      <Link
                        to={HOME_DELEGATION_CERTIFY_DETAIL_APPLY.path}
