...
import {
  ...
  SET_DELEGATION_TECH_APPLY_MANAGER_STATUS,
  SET_DELEGATION_TECH_APPLY_MANAGER_FAIL_STATUS
...
export default props => {
  ...
  const handleSetSuccessStatus = () => {
    (async () => {
      ...
      await proxyFetch(SET_DELEGATION_TECH_APPLY_MANAGER_STATUS, {
  ...
  const handleSetFailStatus = () => {
    if (failManagerText) {
      (async () => {
        ...
        const res = await proxyFetch(SET_DELEGATION_TECH_APPLY_MANAGER_FAIL_STATUS, {
          delegationUuid: enterpriseDelegationUuid,
          failManagerText
        });
