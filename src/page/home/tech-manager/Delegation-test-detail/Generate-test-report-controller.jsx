...
import {
  GENERATE_DELEGATION_REPORT_WORD,
  UPLOAD_WORD_FILE,
  SELECT_TECH_DELEGATION_REPORT,
  GET_FILE_URL,
  SAVE_TECH_DELEGATION_REPORT,
    ...
    form.validateFields(async (err, value) => {
      if (enterpriseDelegationUuid) {
        if (!err) {
          ...
          const res = await proxyFetch(SAVE_TECH_DELEGATION_REPORT, value);
