...
import {
  GET_FILE_URL,
  GET_TECH_LEADER_DELEGATION_REPORT,
  SET_TECH_LEADER_DELEGATION_REPORT_SUCCESS_STATUS,
  SET_TECH_LEADER_DELEGATION_REPORT_FAIL_STATUS,
} from '@/constants/api-constants';

//样式
import { Icon, Button, Tag, Input, message } from 'antd';
import '@/style/home/tech-leader-manager/delegation-task-examine-report.styl';
...
export default (props) => {
  ...
  return (
    <div className='item-box delegation-task-examine-report-box'>
