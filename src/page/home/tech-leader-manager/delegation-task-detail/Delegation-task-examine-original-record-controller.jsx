...
// 路由
import { HOME_DELEGATION_TASK_PROFILE } from '@/constants/route-constants';
...
import {
  GET_FILE_URL,
  GET_TECH_LEADER_DELEGATION_RECORD,
  SET_TECH_LEADER_DELEGATION_RECORD_SUCCESS_STATUS,
  SET_TECH_LEADER_DELEGATION_RECORD_FAIL_STATUS,
} from '@/constants/api-constants';

//样式
import { Icon, Button, Tag, Input, message } from 'antd';
import '@/style/home/tech-leader-manager/delegation-task-examine-original-record.styl';
...
export default (props) => {
  ...
  }, [enterpriseDelegationUuid, formUrl]);

  return (
    <div className='item-box delegation-task-examine-record-box'>
      <p className='title-box'>
        <span>技术负责人审核</span>
      </p>
      <div className='subtitle-box'>
        <Link to={`${HOME_DELEGATION_TASK_PROFILE.path}`}>
