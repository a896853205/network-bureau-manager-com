...
import {
  ...
  SET_DELEGATION_TECH_LEADER_APPLY_MANAGER_STATUS,
  SET_DELEGATION_TECH_LEADER_APPLY_MANAGER_FAIL_STATUS
...
export default props => {
  ...
  const handleSetSuccessStatus = () => {
    (async () => {
      ...
      await proxyFetch(SET_DELEGATION_TECH_LEADER_APPLY_MANAGER_STATUS, {
