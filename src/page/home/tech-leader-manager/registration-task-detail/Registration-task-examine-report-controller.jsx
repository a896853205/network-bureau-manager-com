...
import {
  GET_FILE_URL,
  GET_TECH_LEADER_REGISTRATION_REPORT,
  SET_TECH_LEADER_REGISTRATION_REPORT_SUCCESS_STATUS,
  SET_TECH_LEADER_REGISTRATION_REPORT_FAIL_STATUS
} from '@/constants/api-constants';

//样式
import { Icon, Button, Tag, Input, message } from 'antd';
import '@/style/home/tech-leader-manager/registration-task-examine-report.styl';
...
export default props => {
  ...
  return (
    <div className='item-box registration-task-examine-report-box'>
      ...
      <div className='detail-report-box'>
        ...
        <div className='report-button-box'>
          <Button
            disabled={!(status === 2 || status === -2)}
            type='primary'
            htmlType='submit'
            className={status === 2 || status === -2 ? 'fail-button' : ''}
          ...
          <Button
            ...
            type='primary'
            htmlType='submit'
            className={status === 2 || status === -2 ? 'success-button' : ''}
            loading={statusLoading}
