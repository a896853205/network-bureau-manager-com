...
import {
  GET_FILE_URL,
  GET_CERTIFIER_DELEGATION_REPORT,
  SET_CERTIFIER_DELEGATION_REPORT_SUCCESS_STATUS,
  SET_CERTIFIER_DELEGATION_REPORT_FAIL_STATUS,
} from '@/constants/api-constants';

//样式
import { Icon, Button, Tag, Input, message } from 'antd';
import '@/style/home/certifier-manager/delegation-certify-examine-report.styl';
...
export default (props) => {
  ...
  return (
    <div className='item-box delegation-certify-examine-report-box'>
