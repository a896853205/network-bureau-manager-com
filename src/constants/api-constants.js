...
export const SET_DELEGATION_PROJECT_SPECIMEN_MANAGER_STATUS = `${DominConfigs.DOMAIN}${DominConfigs.PART.OPT_PROJECT_MANAGER}/setProjectSpecimenManagerStatus`; // 设置样品登记表审核通过状态
