...
export const GET_REGISTRATION_FILE_BY_FILE_DOWNLOAD_REGISTRATION_UUID = `${DominConfigs.DOMAIN}${DominConfigs.PART.OPT_TECH_LEADER_MANAGER}/getRegistrationFileByFileDownloadRegistrationUuid`; // 查询4个文件的基本信息
